  ...
  return (
    <div className="w-1/3">
      ...
      <div className="p-4">
        ...
        <input
          type="number"
          value={data["Calories".toLowerCase()][item.toLowerCase()]}
          name={item + " Calories"}
      ...
      <div className="p-4">
        ...
        <input
          type="number"
          value={data["Carbs".toLowerCase()][item.toLowerCase()]}
          name={item + " Carbs"}
          className="bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
          onChange={(e) => onChange(e)}
        ></input>
      ...
      <div className="p-4">
        ...
        <input
          type="number"
          value={data["Fat".toLowerCase()][item.toLowerCase()]}
          name={item + " Fat"}
          className="bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
          onChange={(e) => onChange(e)}
        ></input>
      ...
      <div className="p-4">
        ...
        <input
          type="number"
          value={data["Protein".toLowerCase()][item.toLowerCase()]}
          name={item + " Protein"}
          className="bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
          onChange={(e) => onChange(e)}
        ></input>
